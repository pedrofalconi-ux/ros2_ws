...
static const _Movement_type_support_symbol_names_t _Movement_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_ras_decision, msg, Movement)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_ras_decision, msg, Movement)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_ras_decision, msg, Movement)() {
  return &::robot_ras_decision::msg::rosidl_typesupport_c::Movement_message_type_support_handle;
}
