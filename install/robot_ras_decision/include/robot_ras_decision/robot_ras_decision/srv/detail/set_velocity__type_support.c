...
static rosidl_typesupport_introspection_c__MessageMember robot_ras_decision__srv__SetVelocity_Request__rosidl_typesupport_introspection_c__SetVelocity_Request_message_member_array[1] = {
  {
    ...
    offsetof(robot_ras_decision__srv__SetVelocity_Request, velocity),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember robot_ras_decision__srv__SetVelocity_Response__rosidl_typesupport_introspection_c__SetVelocity_Response_message_member_array[2] = {
  {
    "success",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_ras_decision__srv__SetVelocity_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_ras_decision__srv__SetVelocity_Response, message),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
